...
Esta guía resume el flujo recomendado para insertar una función nueva en
WJPr. Para detalles más extensos, ver la [guía de desarrollo
completa](https://worldjusticeproject-org.github.io/WJPr/articles/development-guide.md).
...
Las funciones deben renombrar columnas de entrada a nombres internos
...
directamente dentro de la función si ya existe un argumento `ptheme`.
...
3.  Si corresponde, agregar un ejemplo visual en
