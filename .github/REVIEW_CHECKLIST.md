...
- [ ] Verifica `is.null()` antes de renombrar parámetros opcionales
...
### Ejemplo
- [ ] Carga librerías necesarias (`library(dplyr)`, etc.)
- [ ] Usa datos de ejemplo simples o `WJPr::gpp`/`WJPr::roli`
...
_Espacio para comentarios adicionales..._
